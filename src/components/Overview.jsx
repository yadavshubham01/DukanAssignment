...
import { RenvneCard } from "./RenvneCard"
    ...
    return (
        <div className="grid gap-6">
         <div className="flex justify-between items-center">
            ...
            <div className="grid grid-flow-col items-center gap-2 h-9 pl-3.5 pr-3.5 rounded border border-y-black">
                <p>This Month</p>
         ...
         <div className="grid grid-cols-1 md:grid-col-2 lg:grid-cols-3 gap-4 justify-between">
          <BlueCard title={"Next payout"} amount={"2,312.23"} orderCount={23}/>
          <RenvneCard title={"Amount Pending"} amount={"92,312.20"} orderCount={13}/>
          <RenvneCard title={"Amount Processed"} amount={"23,92,312.19"}/>
         </div> 
        </div>
    )
}